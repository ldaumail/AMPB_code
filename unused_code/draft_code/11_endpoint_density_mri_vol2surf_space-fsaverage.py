...
def main(participants_file, tract_name, bids_path, pyAFQ_path, ref_space):
    ...
    for participant in participants_file:
        ...
        tract_density_name = tract_name.replace("MT", "MTmask")
        ...
        for h, hemi in enumerate(hemisphere):
            ...
            afq_path = op.join(pyAFQ_path, f"{side}{tract_name}", participant)
        ...
        # -----------------------------
            ...
            # -----------------------------
            mt_density_path = op.join(analysis_path, "tdi_maps", "wmgmi_voxels", participant,f"{participant}_hemi-{hemi}_space-{ref_space}_label-{tract_name}xWMGMI_density.nii.gz")
            ...
            # Output file name
            out_file = os.path.join(out_path, f"{participant}_hemi-{hemi}_space-{ref_space}_label-{tract_name}_desc-fsprojdensity0mm.mgh")
...
if __name__ == "__main__":
    ...
    main(participants, args.tract_name, args.bids_path, args.pyAFQ_path, args.ref_space)
