...
paths_roi = op.join('/Users','ldaumail3','Documents','research','ampb_mt_tractometry_analysis','tests','pyAFQ_tests','wp-afq', 'analysis', 'freesurfer', participant, 'ses-04', 'anat') 
