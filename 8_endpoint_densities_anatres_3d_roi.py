...
# plot 
# plotting.plot_roi(mtL_roi, bg_img=t1w_img, alpha=0.5, cmap="autumn", title="MT")
# plt.show()
...
surface_voxel_mtLcoords = np.argwhere(surface_mtL > 0)
surface_voxel_mtLset = set(map(tuple, surface_voxel_mtLcoords))  # Faster lookup

surface_voxel_mtRcoords = np.argwhere(surface_mtR > 0)
